...
import {getDataUser, isValid} from "@/scripts/store/AuthStore";
                ...
                {item.price && (
                    <View style={styles.detailRow}>
                        ...
                        <Text style={styles.detailText}>
                            Prezzo
                            unitario: {item.price} € {item.unit_of_measurement ? `/${item.unit_of_measurement}` : ''}
                        </Text>
                    </View>
                )}
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyContainer}>
                            ...
                            <Text style={styles.emptySubText}>Clicca sul pulsante in basso per aggiungere la tua prima
                                utenza (es. Luce, Gas, Acqua).</Text>
                        </View>
                    }
                />
            )}
